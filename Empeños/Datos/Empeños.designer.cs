...
namespace Empeños.Datos
{
	...
	public partial class Cliente : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private short _TipoIdentificación;
    ...
    partial void OnCódigoChanging(string value);
    partial void OnCódigoChanged();
    partial void OnTipoIdentificaciónChanging(short value);
    partial void OnTipoIdentificaciónChanged();
    partial void OnNombreChanging(string value);
    partial void OnNombreChanged();
    ...
    partial void OnFotoChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TipoIdentificación", DbType="SmallInt NOT NULL")]
		public short TipoIdentificación
		{
			get
			{
				return this._TipoIdentificación;
			}
			set
			{
				if ((this._TipoIdentificación != value))
				{
					this.OnTipoIdentificaciónChanging(value);
					this.SendPropertyChanging();
					this._TipoIdentificación = value;
					this.SendPropertyChanged("TipoIdentificación");
					this.OnTipoIdentificaciónChanged();
				}
			}
		}
